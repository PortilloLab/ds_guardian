...
def registrar_y_comparar_modelo(
    ...
    """Registra el rendimiento del modelo en JSON y lo compara con iteraciones previas."""
    print(f"
{C_BOLD}{C_BLUE}--- 🕵️ DS Guardian: Registro de Modelos ---{C_RESET}")
    ...
    if nombre_proyecto in historial:
        ...
        print(f"Historial encontrado para '{nombre_proyecto}'. Último {metrica_principal_nombre}: {ultimo_valor:.4f}")
        ...
        if mejoro:
            ...
            print("↔️ Mismo rendimiento que el intento anterior.")
        else:
